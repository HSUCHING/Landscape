  ...
  <div>
    ...
    >
      <el-tabs type="border-card">
        ...
        <el-tab-pane label="产品能力">
          <el-row :gutter="40">
            <el-col :span="16">
              <div class="detail_chars_container">
                <ChartRadar :ability="data.ability"></ChartRadar>
              </div>
            </el-col>
            <el-col :span="8">
        ...
        <el-tab-pane label="商务信息">
          <el-form ref="form" :model="data" label-width="80px" label-position="left" size="small">
            <el-form-item v-for="(value, index) in data.busInfo" :key="index" :label="value.name">
              <a class="detail_sub_link" :underline="false" :href="value.src" target="_blank" v-if="value.src">
                {{ value.value }}
              </a>
              <div v-else>
        ...
        <el-tab-pane label="评价反馈">评价反馈</el-tab-pane>
      </el-tabs>
    </el-dialog>
  </div>
</template>
...
import ChartRadar from '@/components/detail/ChartRadar.vue'
